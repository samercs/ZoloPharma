...
// Ionic
import {
    App, Platform, NavController, ViewController, 
    LoadingController, ModalController, MenuController, 
    Events, NavParams, AlertController, ToastController
} from 'ionic-angular';

export class IonicFeature {
    ...
    public get toastCtrl(): ToastController {
        if (!this._toastCtrl) {
            this._toastCtrl = this._injector.get(ToastController);
        }
